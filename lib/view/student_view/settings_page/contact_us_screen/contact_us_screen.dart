...
class ContactUsStudentScreen extends StatelessWidget {
  const ContactUsStudentScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBarStudent(title: 'Contact Us',) ,
      body: SizedBox(
  ...
  Widget _buildSendEmail(BuildContext context) {
    return CustomElevatedButton(
      onPressed: (){
        Utils.email(email: SharedPreferencesManager.getStudentPorfile()!.email ?? "");
      },
      text: "Send Email",
